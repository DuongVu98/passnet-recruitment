...
public class CompensatingBackupDecorator extends CommandExecutorDecorator{
    ...
    @Builder
    public CompensatingBackupDecorator(CommandExecutor commandExecutor, CompensatingCommandBackupService compensatingBackupService, CompensatingCommandProvider compensatingCommandProvider) {
